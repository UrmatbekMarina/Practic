        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Goods__customer___2E1BDC42",
                        column: x => x.customer_id,
                        principalTable: "Customer",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK__Goods__manufactu__2F10007B",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Category__goods___300424B4",
                        column: x => x.goods_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Delivery__goods___31EC6D26",
                        column: x => x.goods_id,
                        principalTable: "Goods",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK__Delivery__user_i__30F848ED",
                        column: x => x.user_id,
                        principalTable: "User",
                        principalColumn: "id");
                });
